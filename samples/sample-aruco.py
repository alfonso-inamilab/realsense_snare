...
## or cymbals plane orientation. Elimnates noise refelction problem     ## 
##########################################################################
...
try:
    while True:
        ...
        cv2.imshow('Color', color_image)        # color image DEBUG
        cv2.imshow('Real Sense Snare', depth_colormap)  #show depth image with color
        key = cv2.waitKey(1)
